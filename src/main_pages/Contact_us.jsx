  ...
  return (
    <div>
      ...
      <div className=" relative items-top justify-center h-24 min-h-full bg-white dark:bg-gray-900 sm:items-center sm:pt-0">
        <h1 class="pt-8 text-center text-4xl sm:text-5xl text-gray-800 dark:text-white font-extrabold tracking-tight">
          Get in touch
        </h1>
      </div>

      <div class="relative items-top justify-center min-h-screen bg-white dark:bg-gray-900 sm:items-center sm:pt-0">
