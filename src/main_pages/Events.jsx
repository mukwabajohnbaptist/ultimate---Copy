      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 p-6">
        <div className="cursor-pointer rounded-xl bg-white p-3 shadow-lg hover:shadow-xl">
          ...
          <a
              ...
              classNameName="inline-block mb-3 text-2xl font-bold leading-5 transition-colors duration-200 hover:text-deep-purple-accent-700"
            >
              Visit the East
            </a>            <p className="mt-1 text-sm text-slate-400">Italy, Europe</p>
